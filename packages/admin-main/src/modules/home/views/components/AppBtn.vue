...
<style lang="scss" scoped>
  .app-btn {
    @apply bg-bg-page rounded-base cursor-pointer border-none p-spacing-md flex flex-row items-center min-w-0 transition-colors relative overflow-hidden duration-75;
    .app-icon {
    ...
    .app-btn-info {
      @apply text-size-12px color-text-secondary truncate w-full text-left transition-colors mt-spacing-xxxs;
    }
    .deco-icon {
