...
<template>
  <div class="flex flex-row items-center h-full">
    <el-dropdown class="h-full">
      <div class="flex flex-row items-center px-space-sm h-full hover:bg-bg-page">
        <i class="inline-block i-mdi-account-circle text-size-20px mr-space-xxxs" />
        <div class="text-size-base font-semibold color-text-primary select-none">
          {{ userInfo.name }}
        </div>
      </div>
      <template #dropdown>
        <div class="p-space-md bg-bg flex flex-col">
